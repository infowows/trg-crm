...
"[project]/models/Department.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Department$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/Department.ts [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        ...
        const departments = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Department$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).select("_id name description isActive manager employeeCount createdAt updatedAt").sort({
            name: 1
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function POST(request) {
    try {
        ...
        console.log("POST department data:", {
            name,
            description,
            manager
        });
        ...
        // Create department
        const department = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Department$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            name: name.trim(),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__237e312c._.js.map
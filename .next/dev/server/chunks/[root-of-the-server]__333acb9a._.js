...
"[project]/app/api/service-pricing/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const [data, total] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$ServicePricing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
                createdAt: -1
            }).skip(skip).limit(limit),
            __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$ServicePricing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(query)
        ]);
...
async function POST(request) {
    try {
        ...
        const servicePricing = new __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$ServicePricing$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](body);
        ...
        if (error.code === 11000) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "Service pricing already exists"
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__333acb9a._.js.map
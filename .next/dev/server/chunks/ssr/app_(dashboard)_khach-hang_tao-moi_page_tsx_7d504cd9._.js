module.exports = [
"[project]/app/(dashboard)/khach-hang/tao-moi/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CreateCustomer = ()=>{
    ...
    const [serviceGroups, setServiceGroups] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    // Mapbox state
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchData = async ()=>{
            try {
                ...
                const serviceGroupsResponse = await fetch("/api/service-groups", {
                    headers: {
                        Authorization: `Bearer ${token}`
                    }
                });
    ...
    const handleAddressSearch = async (query)=>{
        ...
        searchTimeoutRef.current = setTimeout(async ()=>{
            ...
            try {
                ...
                const baseQuery = query.toLowerCase().includes("việt nam") ? query : `${query}, Việt Nam`;
                searchQueries.push(baseQuery);
                // Nếu query đã có các thành phố lớn, không thêm nữa
                const hasMajorCity = query.toLowerCase().match(/(hà nội|ho chi minh|tp\.hcm|da nang|hanoi|saigon)/);
                // Chỉ thêm các thành phố lớn nếu query không có cụ thể
                if (!hasMajorCity && !query.toLowerCase().includes("quận") && !query.toLowerCase().includes("phường")) {
                ...
                for (const searchQuery of searchQueries){
                    ...
                    while(retryCount < maxRetries && !data){
                        try {
                            const response = await fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(searchQuery)}&countrycodes=VN&limit=${5 - allResults.length}`, {
                                headers: {
                            ...
                            if (response.ok) {
                                ...
                                if (data && data.length > 0) {
                                    // Loại bỏ trùng lặp
                                    const newResults = data.filter((item)=>!allResults.some((existing)=>existing.display_name === item.display_name));
                                    allResults = [
                                        ...allResults,
                                        ...newResults
                                    ];
                            ...
                            console.warn(`Search attempt ${retryCount + 1} failed for query: ${searchQuery}`, error);
                ...
                allResults.sort((a, b)=>{
                    ...
                    const aContainsQuery = a.display_name.toLowerCase().includes(query.toLowerCase());
                    const bContainsQuery = b.display_name.toLowerCase().includes(query.toLowerCase());
    ...
    const handleMapClick = (lat, lng)=>{
        ...
        fetch(`https://api.mapbox.com/geocoding/v5/mapbox.places/${lng},${lat}.json?access_token=pk.eyJ1IjoidG9uMDkxNjQiLCJhIjoiY21rdzIyb2h0MGUxcTNjcTBjdGwwZWVjcCJ9.XvgoEicoaAllA1h_j6m0PA&language=vi`).then((response)=>response.json()).then((data)=>{
            if (data && data.features && data.features.length > 0) {
                const placeName = data.features[0].place_name_vi || data.features[0].place_name;
                setFormData((prev)=>({
                        ...prev,
                        address: placeName
                    }));
    ...
    const handleImageUpload = async (e)=>{
        ...
        try {
            ...
            const response = await fetch(`https://api.cloudinary.com/v1_1/dprxrbz1z/image/upload`, {
                method: "POST",
                body: formData
            });
            if (!response.ok) {
    ...
    const handleGoogleMapsUrl = async (url)=>{
        ...
        try {
            ...
            if (coords) {
                ...
                setShowMap(true);
                // Reverse geocoding using Mapbox API
                const response = await fetch(`https://api.mapbox.com/geocoding/v5/mapbox.places/${coords.lng},${coords.lat}.json?access_token=pk.eyJ1IjoidG9uMDkxNjQiLCJhIjoiY21rdzIyb2h0MGUxcTNjcTBjdGwwZWVjcCJ9.XvgoEicoaAllA1h_j6m0PA&language=vi`);
                if (response.ok) {
                    const data = await response.json();
                    if (data && data.features && data.features.length > 0) {
                        const placeName = data.features[0].place_name_vi || data.features[0].place_name;
                ...
                setError("Không thể lấy tọa độ từ đường dẫn Google Maps. Vui lòng kiểm tra lại URL.");
            }
        } catch (error) {
    ...
    const validateForm = ()=>{
        ...
        if (formData.referrerPhone && !/^[0-9+\-\s()]+$/.test(formData.referrerPhone)) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const submitData = {
                ...
                marketingClassification: formData.marketingClassification.trim() || undefined,
    ...
    const getPotentialIcon = (level)=>{
        switch(level){
            case "Cao":
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$up$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__TrendingUp$3e$__["TrendingUp"], {
                    className: "w-4 h-4"
                }, void 0, false, {
                    fileName: "[project]/app/(dashboard)/khach-hang/tao-moi/page.tsx",
                    lineNumber: 755,
                    columnNumber: 24
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Thêm thông tin khách hàng tiềm năng vào hệ thống"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/khach-hang/tao-moi/page.tsx",
                                                lineNumber: 789,
                                                columnNumber: 33
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                className: "block text-sm font-medium text-gray-700 mb-2",
                                                children: "Đường dẫn Google Maps"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/khach-hang/tao-moi/page.tsx",
                                                lineNumber: 859,
                                                columnNumber: 29
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Dán đường dẫn Google Maps hoặc iframe embed code để tự động lấy tọa độ và địa chỉ"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/khach-hang/tao-moi/page.tsx",
                                                lineNumber: 895,
                                                columnNumber: 29
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    !isSearching && formData.address && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "absolute right-3 top-1/2 transform -translate-y-1/2",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$map$2d$pin$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__MapPin$3e$__["MapPin"], {
                                            ...
                                            searchTimeoutRef.current && !isSearching && formData.address.length >= 3 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            showSuggestions && searchResults.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "mt-1 border border-gray-300 rounded-lg shadow-lg bg-white max-h-60 overflow-y-auto z-50",
                                                children: searchResults.map((result, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        className: `px-3 py-3 cursor-pointer border-b border-gray-100 last:border-b-0 transition-colors ${selectedIndex === index ? "bg-blue-50 text-blue-700 border-l-2 border-blue-500" : "hover:bg-gray-50"}`,
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                selectedIndex === index && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2d$big$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle$3e$__["CheckCircle"], {
                                    ...
                                    showMap && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Click vào bản đồ để chọn vị trí hoặc sử dụng ô tìm kiếm địa chỉ ở trên"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/khach-hang/tao-moi/page.tsx",
                                                lineNumber: 1030,
                                                columnNumber: 33
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            ${uploadingImage ? "border-gray-300 bg-gray-50 cursor-not-allowed" : "border-gray-300 hover:border-blue-400 hover:bg-blue-50"}
                                        `,
                                                                children: uploadingImage ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    lineNumber: 1110,
                                                                    columnNumber: 45
                                                                }, ("TURBOPACK compile-time value", void 0)) : formData.image ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "flex flex-col items-center",
                                                                    children: [
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    ...
                                                    serviceGroups.map((group)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: group.name,
                                                            children: group.name
                                                        }, group._id, false, {
                                                            fileName: "[project]/app/(dashboard)/khach-hang/tao-moi/page.tsx",
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                className: "block text-sm font-medium text-gray-700 mb-2",
                                                children: "Số điện thoại người giới thiệu"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/khach-hang/tao-moi/page.tsx",
                                                lineNumber: 1279,
                                                columnNumber: 29
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                ...
                                                children: [
                                                    ...
                                                    salesPersons.map((person)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
...
const __TURBOPACK__default__export__ = CreateCustomer;
}),
];

//# sourceMappingURL=app_%28dashboard%29_khach-hang_tao-moi_page_tsx_7d504cd9._.js.map
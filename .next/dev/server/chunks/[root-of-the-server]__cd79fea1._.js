...
"[project]/app/api/resolve-maps-url/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const finalUrl = response.headers.get("location") || response.headers.get("Location");
        // Sau khi có finalUrl
        if (finalUrl) {
            ...
            const getFinalUrl = getResponse.headers.get("location") || getResponse.headers.get("Location");
            if (getFinalUrl) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd79fea1._.js.map
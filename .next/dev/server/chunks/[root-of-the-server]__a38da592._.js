...
"[project]/app/api/departments/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const department = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Department$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).populate("manager", "fullName email position").select("_id name description isActive manager employeeCount createdAt updatedAt");
        if (!department) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a38da592._.js.map
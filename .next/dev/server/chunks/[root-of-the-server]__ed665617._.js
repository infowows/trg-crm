...
"[project]/app/api/source-settings/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const sourceSetting = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$SourceSetting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!sourceSetting) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "Không tìm thấy nguồn khách hàng"
            }, {
                status: 404
            });
        }
...
async function PUT(request, { params }) {
    try {
        ...
        const sourceSetting = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$SourceSetting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, {
            ...body,
            updatedAt: new Date()
        }, {
            new: true,
...
async function DELETE(request, { params }) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dbConnect$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const { id } = await params;
        const sourceSetting = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$SourceSetting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
        if (!sourceSetting) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: "Không tìm thấy nguồn khách hàng"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ed665617._.js.map
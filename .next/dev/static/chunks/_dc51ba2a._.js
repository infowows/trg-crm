...
const Dashboard = ()=>{
    ...
    const [selectedGroup, setSelectedGroup] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("all");
    const [displayMode, setDisplayMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "Dashboard.useState": ()=>("TURBOPACK compile-time truthy", 1) ? localStorage.getItem("menuDisplayMode") || "grouped" : "TURBOPACK unreachable"
    }["Dashboard.useState"]);
    ...
    const userData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[userData]": ()=>({
                phan_quyen: "Admin"
            })
    }["Dashboard.useMemo[userData]"], []);
    // Mock menu items - sẽ được thay thế bằng API call
    const menuItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[menuItems]": ()=>[
                ...
                },
                {
                    ...
                    path: "/ke-hoach-cskh",
                    description: "Quản lý kế hoạch chăm sóc khách hàng",
                    groupName: "Khách hàng"
                },
                // Sản phẩm
                {
                    id: "phan_loai_hang_hoa",
                    text: "Phân loại hàng hóa",
                    icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$layers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Layers$3e$__["Layers"],
                    path: "/phan-loai-hang-hoa",
                    description: "Phân loại hàng hóa dịch vụ",
                    groupName: "Quản lý sản phẩm"
                },
                {
                    id: "danh_muc_hang_hoa",
                ...
                },
                {
                    ...
                    description: "Quản lý phụ lục hợp đồng",
                    groupName: "Báo giá & Hợp đồng"
                },
                // Thanh toán
                {
                ...
                },
                {
                    ...
                    path: "/hoa-don-vat",
                    description: "Quản lý hóa đơn VAT",
                    groupName: "Thanh toán"
                },
                // Hệ thống
                {
    ...
    const groups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[groups]": ()=>{
            const uniqueGroups = Array.from(new Set(menuItems.map({
                "Dashboard.useMemo[groups].uniqueGroups": (item)=>item.groupName
            }["Dashboard.useMemo[groups].uniqueGroups"])));
            return uniqueGroups.map({
                "Dashboard.useMemo[groups]": (groupName)=>({
                        name: groupName,
                        items: menuItems.filter({
                            "Dashboard.useMemo[groups]": (item)=>item.groupName === groupName
                        }["Dashboard.useMemo[groups]"])
                    })
            }["Dashboard.useMemo[groups]"]);
        }
    ...
    // Check permission - memoized to prevent infinite loop
    const checkPermission = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[checkPermission]": ()=>{
            return ({
                "Dashboard.useMemo[checkPermission]": (item)=>{
                    if (!item.permissions || !item.permissions.phan_quyen) {
                        return true;
                    }
                    return item.permissions.phan_quyen.includes(userData.phan_quyen) || item.permissions.phan_quyen.includes("All");
                }
            })["Dashboard.useMemo[checkPermission]"];
        }
    }["Dashboard.useMemo[checkPermission]"], [
    ...
    // Filter items using useMemo instead of useEffect
    const filteredItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[filteredItems]": ()=>{
            let filtered = menuItems.filter(checkPermission);
            if (selectedGroup !== "all") {
                filtered = filtered.filter({
                    "Dashboard.useMemo[filteredItems]": (item)=>item.groupName === selectedGroup
                }["Dashboard.useMemo[filteredItems]"]);
            }
            if (searchQuery) {
                filtered = filtered.filter({
                    "Dashboard.useMemo[filteredItems]": (item)=>item.text.toLowerCase().includes(searchQuery.toLowerCase()) || item.description.toLowerCase().includes(searchQuery.toLowerCase())
                }["Dashboard.useMemo[filteredItems]"]);
            }
            return filtered;
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Chào mừng trở lại! Chọn chức năng để bắt đầu làm việc."
                                    }, void 0, false, {
                                        fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                        lineNumber: 313,
                                        columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "flex items-center px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition",
                                        children: [
                                            displayMode === "grouped" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$list$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__List$3e$__["List"], {
                                                className: "w-5 h-5 mr-2"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                                lineNumber: 345,
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: `px-4 py-2 rounded-lg transition ${selectedGroup === "all" ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`,
                                    children: "Tất cả"
                                }, void 0, false, {
                                    fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                    lineNumber: 358,
                                ...
                                groups.map((group)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `px-4 py-2 rounded-lg transition ${selectedGroup === group.name ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`,
                                        children: group.name
                                    }, group.name, false, {
                                        fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                        lineNumber: 369,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    displayMode === "grouped" ? // Grouped view
                    groups.map((group)=>{
                        const groupItems = filteredItems.filter((item)=>item.groupName === group.name);
                                        ...
                                        children: groupItems.map((item)=>{
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "p-2 bg-blue-50 rounded-lg group-hover:bg-blue-100 transition",
                    ...
                    filteredItems.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                ...
                                children: "Không tìm thấy chức năng"
                            }, void 0, false, {
                                fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                lineNumber: 504,
                                columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-gray-600",
                                children: searchQuery ? `Không có kết quả cho "${searchQuery}"` : "Không có chức năng nào trong nhóm được chọn"
                            }, void 0, false, {
                                fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                lineNumber: 507,
                                columnNumber: 25
...
_s(Dashboard, "YQhUjW7E1cGL5rzsPSM8dl6M8ys=", false, function() {
    return [
...
//# sourceMappingURL=_dc51ba2a._.js.map
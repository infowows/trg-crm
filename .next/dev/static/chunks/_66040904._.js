...
"[project]/app/(dashboard)/phong-ban/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const PhongBanManagement = ()=>{
    ...
    const [phongBans, setPhongBans] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    const [searchQuery, setSearchQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [selectedPhongBans, setSelectedPhongBans] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhongBanManagement.useEffect": ()=>{
            const mockPhongBans = [
                {
                    id: "1",
                    ma_phong_ban: "BGD",
                    ten_phong_ban: "Ban Giám đốc",
                    mo_ta: "Ban điều hành cao nhất của công ty",
                    phong_ban_cha: "",
                    nguoi_quan_ly: "Nguyễn Văn Giám đốc",
                    so_luong_nhan_vien: 3,
                    trang_thai: "active",
                    ngay_tao: "2024-01-01",
                    ngay_cap_nhat: "2024-01-15",
                    email: "bgd@trgcrm.com",
                ...
                },
                {
                    ...
                    mo_ta: "Phòng chịu trách nhiệm kinh doanh và marketing",
                    phong_ban_cha: "BGD",
                    nguoi_quan_ly: "Trần Thị Trưởng phòng",
                    so_luong_nhan_vien: 15,
                    trang_thai: "active",
                    ngay_tao: "2024-01-02",
                    ngay_cap_nhat: "2024-01-10",
                    email: "kinhdoanh@trgcrm.com",
                ...
                },
                {
                    ...
                    mo_ta: "Phòng chịu trách nhiệm tài chính kế toán",
                    phong_ban_cha: "BGD",
                    nguoi_quan_ly: "Lê Văn Kế toán",
                    so_luong_nhan_vien: 8,
                    trang_thai: "active",
                    ngay_tao: "2024-01-03",
                    ngay_cap_nhat: "2024-01-08",
                    email: "ketoan@trgcrm.com",
                    so_dien_thoai: "0923456789"
                }
            ];
            setTimeout({
                "PhongBanManagement.useEffect": ()=>{
                    setPhongBans(mockPhongBans);
                    setLoading(false);
                }
            }["PhongBanManagement.useEffect"], 1000);
        }
    }["PhongBanManagement.useEffect"], []);
    // Filter phòng ban
    const filteredPhongBans = phongBans.filter((phongBan)=>{
        const matchesSearch = phongBan.ten_phong_ban.toLowerCase().includes(searchQuery.toLowerCase()) || phongBan.ma_phong_ban.toLowerCase().includes(searchQuery.toLowerCase()) || phongBan.mo_ta.toLowerCase().includes(searchQuery.toLowerCase());
        const matchesFilters = (!filters.trang_thai || phongBan.trang_thai === filters.trang_thai) && (!filters.phong_ban_cha || phongBan.phong_ban_cha === filters.phong_ban_cha);
        return matchesSearch && matchesFilters;
    });
    // Handle selection
    const handleSelectPhongBan = (phongBanId)=>{
        setSelectedPhongBans((prev)=>prev.includes(phongBanId) ? prev.filter((id)=>id !== phongBanId) : [
                ...prev,
                phongBanId
            ]);
    };
    ...
    const handleSelectAll = ()=>{
        if (selectedPhongBans.length === filteredPhongBans.length) {
            setSelectedPhongBans([]);
        } else {
            setSelectedPhongBans(filteredPhongBans.map((phongBan)=>phongBan.id));
        }
    };
    // Handle delete
    const handleDeletePhongBan = (phongBanId)=>{
        if (window.confirm("Bạn có chắc chắn muốn xóa phòng ban này?")) {
            setPhongBans((prev)=>prev.filter((phongBan)=>phongBan.id !== phongBanId));
            setSelectedPhongBans((prev)=>prev.filter((id)=>id !== phongBanId));
        }
    };
    // Handle delete selected
    const handleDeleteSelected = ()=>{
        if (window.confirm(`Bạn có chắc chắn muốn xóa ${selectedPhongBans.length} phòng ban đã chọn?`)) {
            setPhongBans((prev)=>prev.filter((phongBan)=>!selectedPhongBans.includes(phongBan.id)));
            setSelectedPhongBans([]);
        }
    };
    // Get status badge
    const getStatusBadge = (status)=>{
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            children: status === "active" ? "Hoạt động" : "Không hoạt động"
        }, void 0, false, {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Quản lý thông tin phòng ban trong công ty"
                                            }, void 0, false, {
                                                fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                                lineNumber: 201,
                                                columnNumber: 29
                    ...
                    showFilters && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    value: filters.phong_ban_cha,
                                    onChange: (e)=>setFilters((prev)=>({
                                                ...prev,
                                                phong_ban_cha: e.target.value
                                            })),
                                    className: "px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: "",
                                            children: "Tất cả phòng ban cha"
                                        }, void 0, false, {
                                            fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                            lineNumber: 287,
                                            columnNumber: 33
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: "",
                                            children: "Không có phòng ban cha"
                                        }, void 0, false, {
                                            fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                            lineNumber: 288,
                                            columnNumber: 33
                    ...
                    selectedPhongBans.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                ...
                                children: [
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                        type: "checkbox",
                                                        checked: selectedPhongBans.length === filteredPhongBans.length,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                        ...
                                        children: filteredPhongBans.map((phongBan)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                            type: "checkbox",
                                                            checked: selectedPhongBans.includes(phongBan.id),
                                                            onChange: ()=>handleSelectPhongBan(phongBan.id),
                                                            className: "rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                                            lineNumber: 366,
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                            ...
                                                                            children: phongBan.ten_phong_ban
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                                                            lineNumber: 385,
                                                                            columnNumber: 57
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "flex items-center text-gray-900 mb-1",
                                                                    children: [
                                                                ...
                                                                phongBan.email && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "text-xs text-gray-500",
                                                                    children: phongBan.email
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                                                    lineNumber: 409,
                                                                    columnNumber: 57
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "text-sm font-medium text-gray-900",
                                                                    children: phongBan.so_luong_nhan_vien
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                                                    lineNumber: 418,
                                                                    columnNumber: 53
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-6 py-4",
                                                        children: getStatusBadge(phongBan.trang_thai)
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                                        lineNumber: 425,
                                                        columnNumber: 45
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: new Date(phongBan.ngay_tao).toLocaleDateString("vi-VN")
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/(dashboard)/phong-ban/page.tsx",
                                                        lineNumber: 430,
                                                        columnNumber: 45
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    onClick: ()=>router.push(`/phong-ban/${phongBan.id}`),
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    onClick: ()=>router.push(`/phong-ban/${phongBan.id}/chinh-sua`),
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    onClick: ()=>handleDeletePhongBan(phongBan.id),
...
_s(PhongBanManagement, "q3+0hMh7Oo8YIvCpH7RzgtHhBVM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = PhongBanManagement;
const __TURBOPACK__default__export__ = PhongBanManagement;
var _c;
__turbopack_context__.k.register(_c, "PhongBanManagement");
...
//# sourceMappingURL=_66040904._.js.map
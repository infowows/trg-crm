...
const EditSurvey = () => {
    ...
    const calculateVolume = (length: number, width: number, coefficient: number) => {
    ...
    const updateSurvey = (index: number, field: string, value: any) => {
        ...
        if (["length", "width", "coefficient"].includes(field)) {
            ...
            const coefficient = parseFloat(String(newSurveys[index].coefficient)) || 1;
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            value={survey.length}
                                            onChange={(e) =>
                                                updateSurvey(index, "length", parseFloat(e.target.value) || 0)
                                            }
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                                            min="0"
                                            step="0.1"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            value={survey.width}
                                            onChange={(e) =>
                                                updateSurvey(index, "width", parseFloat(e.target.value) || 0)
                                            }
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                                            min="0"
                                            step="0.1"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) =>
                                                updateSurvey(index, "coefficient", parseFloat(e.target.value) || 1)
                                            }
                                            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none"
                                            min="0"
                                            step="0.01"

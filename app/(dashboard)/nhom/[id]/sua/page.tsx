...
const EditCategoryGroupPage = () => {
    ...
    const fetchCategoryGroup = async () => {
        try {
            ...
            if (response.ok) {
                ...
                throw new Error("Không thể tải thông tin nhóm hạng mục");
            }
        } catch (err) {
            console.error("Error fetching category group:", err);
            setError("Không thể tải thông tin nhóm hạng mục");
        } finally {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const data = await response.json();
            if (data.success) {
                setSuccess("Cập nhật nhóm hạng mục thành công!");
                setTimeout(() => {
                    router.push("/nhom");
                }, 2000);
            }
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 mt-1 ml-6">
                            Bỏ chọn để ẩn nhóm này khỏi hệ thống
                        </p>
                    </div>
...
export default EditCategoryGroupPage;

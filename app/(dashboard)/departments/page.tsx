  ...
  const fetchDepartments = async () => {
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.message || "Không thể tải danh sách phòng ban");
      }
    } catch (error) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/departments?id=${selectedDepartment._id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Đang tải danh sách phòng ban...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              onClick={() => router.push("/departments/tao-moi")}
                ...
                <tr key={department._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <button
                        onClick={() =>
                          router.push(`/departments/${department._id}/edit`)
                        }
          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                ...
                <span className="font-medium">{departments.length}</span> trong{" "}
                <span className="font-medium">{departments.length}</span> kết
                quả
              </p>
            </div>
            <div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-900">
                        {selectedDepartment.manager || "Chưa phân công"}
                      </p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-500">
                      ...
                      <p className="mt-1 text-sm text-gray-900">
                        {selectedDepartment.employeeCount || 0} nhân viên
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                ...
                <button
                  onClick={() => {
                    ...
                    router.push(`/departments/${selectedDepartment._id}/edit`);
                  }}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6 shadow-xl">
            ...
            <p className="text-center text-gray-600 mb-6">
              ...
              <strong>{selectedDepartment.name}</strong>? Hành động này không
              thể hoàn tác.
            </p>

    ...
    const fetchServiceGroups = async (
        ...
        try {
            ...
            const response = await fetch(
                `/api/service-groups?${params.toString()}`,
                {
                    headers: {
        ...
        return (
            <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600">Đang tải danh sách nhóm dịch vụ...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            onClick={() =>
                                router.push("/services/nhom-dich-vu/tao-moi")
                            }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="flex items-center justify-center md:justify-end">
                            <span className="text-sm text-gray-600">
                                Tổng số: <span className="font-semibold">{total}</span> nhóm dịch vụ
                            </span>
                        </div>
                    </div>
                </div>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <div className="flex items-center justify-end space-x-2">
                                                    <button
                                                        onClick={() =>
                                                            router.push(
                                                                `/services/nhom-dich-vu/${group._id}`
                                                            )
                                                        }
                                                    ...
                                                    <button
                                                        onClick={() =>
                                                            router.push(
                                                                `/services/nhom-dich-vu/${group._id}/edit`
                                                            )
                                                        }

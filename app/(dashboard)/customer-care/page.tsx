              ...
              {viewingItem.files && viewingItem.files.length > 0 && (
                <div className="mt-6">
                  ...
                  <div className="space-y-2">
                    {viewingItem.files.map((file, index) => {
                      // Support both old format (string) and new format (FileMetadata)
                      const fileUrl =
                      ...
                      return (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center p-3 bg-gray-50 rounded-lg hover:bg-blue-50 transition group"
                        >
                          <svg
                            className="w-5 h-5 text-gray-400 group-hover:text-blue-600 mr-3"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
